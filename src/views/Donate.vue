...
<br/>
            <div class="container">
                <div class="text-center">
                    <button class="button"  onclick="location.href='https://www.chakanmilk.com/index.do'">
              <div class="lid">
...
<br/>
            ...
            <p><del>후원은</del>칭찬은 개발자를 움직이게 한다</p>
            <h3 class="section-subheading text-muted">🙏문의는 디엠 주세요🙏</h3>
