									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group">
                                                ...
                                                <input type="text" id="id" class="form-style" v-model="user.userid">
												<!-- <input type="email" class="form-style" placeholder="Email"> -->
												<i class="input-icon uil uil-at"></i>
											</div>	
											<div class="form-group mt-2">
                                                <!-- <label for="password" class="form-label">비밀번호</label> -->
                                                <input type="password" id="password" class="form-style" v-model="user.password">
												<!-- <input type="password" class="form-style" placeholder="Password"> -->
												<i class="input-icon uil uil-lock-alt"></i>
											</div>
											<a class="btn mt-4"  @click="[signUp()]" >Login</a>
				      					</div>
			      					</div>
			      				</div>
                                  <div class="card-back">
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group mt-2">
                                                <input v-model="user.password" class="form-style" type="password" placeholder="Password" id="password" value>
												<i class="input-icon uil uil-lock-alt"></i>
											</div>
											<a class="btn mt-4"  @click="[register()]">Register</a>
				      					</div>
			      					</div>
			      				</div>
			      			</div>
